...
import redBlur from '../../static/core/red-blur.png';
import cyanBlur from '../../static/core/cyan-blur.png';
...
export function paper({ theme, color, dropdown }: PaperProps): CSSObject {
  return {
    ...bgBlur({
