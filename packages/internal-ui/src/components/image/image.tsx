...
import transparentImg from '../../static/core/transparent.png';
import placeholderSvg from '../../static/core/placeholder.svg';
  ...
  (
    ...
    const content = (
      <Box
        ...
        placeholderSrc={
          visibleByDefault || disabledEffect ? `'${transparentImg}'` : `'${placeholderSvg}'`
        }
        sx={{
          width: 1,
          height: 1,
